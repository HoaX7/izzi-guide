...
- Beating each tower increases the difficulty of the next floor boss.
- Beating each floor also increase the difficulty of the next floor boss.
- If you lose at any point in the run your floor will be reset to 1 and you will go down 2 - 3 towers.

## Rewards
- Fruits, Fragments, Gems,  Exp, Gold, Izzi Exp.
- Reward increases based on boss difficulty and towers climbed.
