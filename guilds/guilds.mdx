...
to create a guild.
<Info>100,000 gold will be automatically added to your clan gold.</Info> <img class="rounded-md" src="../images/guild-create.jpg" />
...
### Usage
- command: `iz guild` <img class="rounded-md" src="../images/guild.jpg" />

## How to Level Up Guild
- Requires Souls, Seals to upgrade guild and gain bonus stats.

### Usage
- command: `iz guild upgrade` <img class="rounded-md" src="../images/guild-upgrade.jpg" />

## Guild Invite
- Invite your friends to your guild using `iz guild inv @user`. <img class="rounded-md" src="../images/guild-inv.jpg" /> <img class="rounded-md" src="../images/guild-inv2.jpg" />

## Kicking from Guild
- Only guild admins and owner can kick members from a Guild.

### Usage
- command: `iz guild kick @user` <img class="rounded-md" src="../images/guild-kick.jpg" />
...
### Usage
- command: `iz guild donate <amount>` <img class="rounded-md" src="../images/guild-donate.jpg" />
