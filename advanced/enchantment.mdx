...
<Note>If no filters are specified the Bot will automatically choose the number of cards required at random to reach max level.</Note>
- You can specify the name of the fodders to consume using `iz enh 781 -n akane`. <img class="rounded-md" src="../images/enh.jpg" />
- Limit the number cards you want to consume using `iz enh 55 -l 10`. <img class="rounded-md" src="../images/enh2.jpg" /> 
<img class="rounded-md" src="../images/iz-enh.gif" />
...
<img class="rounded-md" src="../images/cards.jpg" />
