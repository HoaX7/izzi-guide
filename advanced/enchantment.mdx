...
- You can specify the name of the fodders to consume using `iz enh 781 -n akane`. <img src="../images/enh.jpg" />
- Limit the number cards you want to consume using `iz enh 55 -l 10`. <img src="../images/enh2.jpg" /> 
<img src="../images/iz-enh.gif" />
