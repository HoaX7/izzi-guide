...
### Usage
- command: `iz rd` <img class="rounded-md" src="../images/rd.jpg" />
...
raid view embed in your DM, or on public lobbies. <img class="rounded-md" src="../images/rdlobby.jpg" />
...
<Note>60% vote is required to kick a player from the party.</Note> <img class="rounded-md" src="../images/rd-kick.jpg" />
