...
---
- To fast forward a battle use `hidebt`. Ex: `iz rd bt hidebt`, `iz rd bt all hidebt`. <img src="../images/hidebt.jpg" />
## Starting a Raid
- Once all your party members are ready to take on the raid challenge, the raid leader must start the raid.

### Usage
- command: `iz rd start`
<Note>Starting a raid consumes 2 raid permits.</Note> <img src="../images/rdstart.jpg" />
...
### Usage
- command: `iz rd bt all` <img src="../images/rdbt.jpg" />
- command: `iz rd e` <img src="../images/rdenergy.jpg" />
