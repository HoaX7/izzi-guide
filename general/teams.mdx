...
- You can create a new team using `iz tm create <name>`. You can create up to a maximum of 5 teams. <img class="rounded-md" src="../images/tm-create.jpg" />

## Assign Cards to a Team
- You can assign up to 3 cards in a team. `card ID` refers to the `card row number` in your inventory.

### Usage
- command: `iz tm set <card ID> <team name>` <img class="rounded-md" src="../images/tm-set.jpg" />

## View your Team
### Usage
- command: `iz tm view <team name>` <img class="rounded-md" src="../images/tm-view1.jpg" />

## Selecting a Team for Battle
### Usage
- command: `iz tm select <team name>` <img class="rounded-md" src="../images/tm-select.jpg" />
...
<img class="rounded-md" src="../images/tm-reset.jpg" /> <img class="rounded-md" src="../images/tm-remove.jpg" />
